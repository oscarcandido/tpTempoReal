...
HBITMAP * GUI_PutImage(int xPos,int yPos,int width,int height, const char *path)
{
	...
	// hdc = BeginPaint(hwnd, &ps); teste remocao
	...
	//EndPaint(hwnd, &ps); teste remocao
...
void GUI_DrawImage(HBITMAP * hbitmap, int xPos,int yPos,int width,int height, int index)//GUI_DrawImage
{
	RECT prc;
	...
	// - teste
	if(index==1){
		prc_last1.left = prc_last1.left;
		prc_last1.top  = prc_last1.top;
		prc_last1.right = prc_last1.right;
		prc_last1.bottom = prc_last1.bottom;

		FillRect(hdc, &prc_last1, (HBRUSH)(WHITE_BRUSH));
		prc_last1 = prc;
	}
	if(index==2){
		prc_last2.left = prc_last2.left;
		prc_last2.top  = prc_last2.top;
		prc_last2.right = prc_last2.right;
		prc_last2.bottom = prc_last2.bottom;

		FillRect(hdc, &prc_last2, (HBRUSH)(WHITE_BRUSH));
		prc_last2 = prc;
	}
	if(index==3){
		prc_last3.left = prc_last3.left;
		prc_last3.top  = prc_last3.top;
		prc_last3.right = prc_last3.right;
		prc_last3.bottom = prc_last3.bottom;

		FillRect(hdc, &prc_last3, (HBRUSH)(WHITE_BRUSH));
		prc_last3 = prc;
	}
	if(index==4){
		prc_last4.left = prc_last4.left;
		prc_last4.top  = prc_last4.top;
		prc_last4.right = prc_last4.right;
		prc_last4.bottom = prc_last4.bottom;

		FillRect(hdc, &prc_last4, (HBRUSH)(WHITE_BRUSH));
		prc_last4 = prc;
	}
	if(index==5){
		prc_last5.left = prc_last5.left;
		prc_last5.top  = prc_last5.top;
		prc_last5.right = prc_last5.right;
		prc_last5.bottom = prc_last5.bottom;

		FillRect(hdc, &prc_last5, (HBRUSH)(WHITE_BRUSH));
		prc_last5 = prc;
	}
	if(index==6){
		prc_last6.left = prc_last6.left;
		prc_last6.top  = prc_last6.top;
		prc_last6.right = prc_last6.right;
		prc_last6.bottom = prc_last6.bottom;

		FillRect(hdc, &prc_last6, (HBRUSH)(WHITE_BRUSH));
		prc_last6 = prc;
	}
	// --teste
...
void ReDraw(HBITMAP* image, int xPos,int yPos,int width,int height)//ReDraw
{
	HDC hdcBuffer = CreateCompatibleDC(hdc);
...
void GUI_CreateEditLine(int xPos, int yPos, int width, int editID)
{
	...
	SetWindowPos(hEdit, NULL, prc.left, prc.top, width, 25, SWP_NOZORDER);
